...
// translateCareEnToZh 将英文养护描述翻译为中文（常见模板句式）
func translateCareEnToZh(s string) string {
	...
	s = replaceAll(s, "like partial shade", "喜半阴环境")
	s = replaceAll(s, "Likes partial shade", "喜半阴环境")
	...
	s = replaceAll(s, "growing seasons", "生长季")
	...
	s = replaceAll(s, "timely remove old, diseased, and dead leaves", "及时清除老叶、病叶和枯叶")
	s = replaceAll(s, "Remove dead", "清除枯死")
	s = replaceAll(s, "remove dead", "清除枯死")
	s = replaceAll(s, "Remove diseased", "清除病害")
	s = replaceAll(s, "remove diseased", "清除病害")
	s = replaceAll(s, "Remove withered", "清除枯萎")
	s = replaceAll(s, "remove withered", "清除枯萎")
	s = replaceAll(s, "Remove old", "清除老叶")
	s = replaceAll(s, "remove old", "清除老叶")
	...
	s = replaceAll(s, "in spring and autumn", "在春秋两季")
	s = replaceAll(s, "in spring and summer", "在春夏两季")
	s = replaceAll(s, "during the growing season", "在生长季")
	s = replaceAll(s, "when the topsoil is dry", "表土干燥时")
	s = replaceAll(s, "When the topsoil is dry", "表土干燥时")
	s = replaceAll(s, "after the soil has dried", "土壤干燥后")
	s = replaceAll(s, "once the soil has dried", "土壤干燥后")
	s = replaceAll(s, "Keep the plant", "保持植株")
	s = replaceAll(s, "keep the plant", "保持植株")
	s = replaceAll(s, "Place in", "放置在")
	s = replaceAll(s, "place in", "放置在")
	s = replaceAll(s, "Place the plant", "将植株放置在")
	s = replaceAll(s, "place the plant", "将植株放置在")
	s = replaceAll(s, "Do not", "不要")
	s = replaceAll(s, "do not", "不要")
	s = replaceAll(s, "Avoid", "避免")
	s = replaceAll(s, "avoid", "避免")
	s = replaceAll(s, "Ensure", "确保")
	s = replaceAll(s, "ensure", "确保")
	s = replaceAll(s, "Allow", "让")
	s = replaceAll(s, "allow", "让")
	s = replaceAll(s, "Provide", "提供")
	s = replaceAll(s, "provide", "提供")
	s = replaceAll(s, "Use", "使用")
	s = replaceAll(s, "use", "使用")
	s = replaceAll(s, "water", "浇水")
	s = replaceAll(s, "Water", "浇水")
	s = replaceAll(s, "fertilize", "施肥")
	s = replaceAll(s, "Fertilize", "施肥")
	s = replaceAll(s, "prune", "修剪")
	s = replaceAll(s, "Prune", "修剪")
	s = replaceAll(s, "soil", "土壤")
	s = replaceAll(s, "Soil", "土壤")
	s = replaceAll(s, "light", "光照")
	s = replaceAll(s, "Light", "光照")
	s = replaceAll(s, "sun", "阳光")
	s = replaceAll(s, "Sun", "阳光")
	s = replaceAll(s, "shade", "阴凉处")
	s = replaceAll(s, "Shade", "阴凉处")
	s = replaceAll(s, "moist", "湿润")
	s = replaceAll(s, "Moist", "湿润")
	s = replaceAll(s, "dry", "干燥")
	s = replaceAll(s, "Dry", "干燥")
	s = replaceAll(s, "warm", "温暖")
	s = replaceAll(s, "Warm", "温暖")
	s = replaceAll(s, "cool", "凉爽")
	s = replaceAll(s, "Cool", "凉爽")
	s = replaceAll(s, "humid", "湿润")
	s = replaceAll(s, "Humid", "湿润")
	s = replaceAll(s, "well-drained", "排水良好")
	s = replaceAll(s, "Well-drained", "排水良好")
	s = replaceAll(s, "well-draining", "排水良好")
	s = replaceAll(s, "Well-draining", "排水良好")
	s = replaceAll(s, "loose", "疏松")
	s = replaceAll(s, "Loose", "疏松")
	s = replaceAll(s, "rich", "肥沃")
	s = replaceAll(s, "Rich", "肥沃")
	s = replaceAll(s, "direct", "直射")
	s = replaceAll(s, "Direct", "直射")
	s = replaceAll(s, "indirect", "散射")
	s = replaceAll(s, "Indirect", "散射")
	s = replaceAll(s, "bright", "明亮")
	s = replaceAll(s, "Bright", "明亮")
	s = replaceAll(s, "partial", "部分")
	s = replaceAll(s, "Partial", "部分")
	s = replaceAll(s, "full", "全")
	s = replaceAll(s, "Full", "全")
	s = replaceAll(s, "monthly", "每月")
	s = replaceAll(s, "Monthly", "每月")
	s = replaceAll(s, "weekly", "每周")
	s = replaceAll(s, "Weekly", "每周")
	s = replaceAll(s, "regularly", "定期")
	s = replaceAll(s, "Regularly", "定期")
	s = replaceAll(s, "promptly", "及时")
	s = replaceAll(s, "Promptly", "及时")
	s = replaceAll(s, "timely", "及时")
	s = replaceAll(s, "Timely", "及时")
	s = replaceAll(s, "dilute", "稀释")
	s = replaceAll(s, "Dilute", "稀释")
	s = replaceAll(s, "balanced", "均衡")
	s = replaceAll(s, "Balanced", "均衡")
	s = replaceAll(s, "liquid", "液态")
	s = replaceAll(s, "Liquid", "液态")
	s = replaceAll(s, "slow-release", "缓释")
	s = replaceAll(s, "Slow-release", "缓释")
	s = replaceAll(s, "topsoil", "表土")
	s = replaceAll(s, "Topsoil", "表土")
	s = replaceAll(s, "peat", "泥炭")
	s = replaceAll(s, "Peat", "泥炭")
	s = replaceAll(s, "sand", "砂土")
	s = replaceAll(s, "Sand", "砂土")
	s = replaceAll(s, "loam", "壤土")
	s = replaceAll(s, "Loam", "壤土")
	s = replaceAll(s, "acidic", "酸性")
	s = replaceAll(s, "Acidic", "酸性")
	s = replaceAll(s, "ph", "酸碱度")
	s = replaceAll(s, "PH", "酸碱度")
	s = replaceAll(s, "frost", "霜冻")
	s = replaceAll(s, "Frost", "霜冻")
	s = replaceAll(s, "freezing", "结冰")
	s = replaceAll(s, "Freezing", "结冰")
	s = replaceAll(s, "temperature", "温度")
	s = replaceAll(s, "Temperature", "温度")
	s = replaceAll(s, "humidity", "湿度")
	s = replaceAll(s, "Humidity", "湿度")
	s = replaceAll(s, "ventilation", "通风")
	s = replaceAll(s, "Ventilation", "通风")
	s = replaceAll(s, "airflow", "空气流通")
	s = replaceAll(s, "Airflow", "空气流通")
	return s
}
